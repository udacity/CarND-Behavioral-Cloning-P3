...
2. You could slightly alter the code in `drive.py` and/or `video.py` to create a video of what your model after the image is processed (may be helpful for debugging).
