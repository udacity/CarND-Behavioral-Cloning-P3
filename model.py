...
from keras.layers import Dense, Flatten, Conv2D, InputLayer, Dropout, MaxPool2D, Cropping2D
...
def build_model():
    ...
    model = Sequential()
    model.add(Cropping2D(input_shape=image_shape, cropping=((50, 20), (0, 0))))
