...
debug_show_example_images = 2  # 0: off, >0: number of show events
...
generator_new_item_multiplier = 4  # generator will output twice the amount of its input by adding flipped images
...
camera_steer_multiplier = 1.4  # multiplies the steering angle
ignore_zero_steer_items_from = 10 # from this number of items... (see next line)
ignore_zero_steer_items_skip = 9   # ...skip this number of items (prev line contd)
